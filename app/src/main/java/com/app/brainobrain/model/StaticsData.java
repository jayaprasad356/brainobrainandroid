...
public class StaticsData {
    ...
    public String getAverage_time_taken() {
        return average_time_taken;
    }

    public void setAverage_time_taken(String average_time_taken) {
        this.average_time_taken = average_time_taken;
    }
